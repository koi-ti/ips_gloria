...
class ReportesController extends \BaseController {
	...
	public function acumulados()
	{
		...
		$data['abdomen'] = Report::getAcumuladosAbdomen();
		$data['columna'] = Report::getAcumuladosColumna();
		$data['extremidades'] = Report::getAcumuladosExtremidades();
		$data['varices'] = Report::getAcumuladosVarices();
