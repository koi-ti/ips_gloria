...
@section ('content')
    ...
    <div class="row">
        ...
        @if(@$permission->adiciona)
	        <div class="form-group col-md-2">
	            <a href="{{ route('planilla.pacientes.create') }}" class="btn btn-success">Nuevo paciente</a>
	        </div>
	  	@endif
    </div> 
	...
	<br/>
 	{{ Form::close() }}
	<div id="customers">
		@include('core.worksheet.customers.customers')
	</div>

	<script type="text/javascript">		
		var customers = { 			
			search : function(){
				window.Misc.search('form-search-customers', 'customers', '/planilla/pacientes'); 
			},
