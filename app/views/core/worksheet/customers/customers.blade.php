			...
			@foreach ($customers as $customer)
				<tr>
					...
					<td nowrap="nowrap" style="text-align:right">					
						<a href="{{ route('planilla.pacientes.show', $customer->id) }}" class="btn btn-info">Ver</a>
					    @if(@$permission->modifica)
							<a href="{{ route('planilla.pacientes.edit', $customer->id) }}" class="btn btn-primary">Editar</a>
						@endif
					</td>
				</tr>
			@endforeach	
