            ...
            <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                <div class="panel-body">
                    ...
                    <div class="row"> 
                        <div class="form-group col-md-3">
                            ...
                            @foreach($abdomen as $key => $value)
                                <li class="list-group-item">
                                    <span class="badge">{{ $value }}</span> {{ in_array($key, array_keys(Certificate::$abdomen)) ? Certificate::$abdomen[$key] : $key }}
                                </li>
                            @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="row"> 
                        <div class="form-group col-md-3">
                            ...
                            @foreach($columna as $key => $value)
                                <li class="list-group-item">
                                    <span class="badge">{{ $value }}</span> {{ in_array($key, array_keys(Certificate::$columna)) ? Certificate::$columna[$key] : $key }}
                                </li>
                            @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="row"> 
                        <div class="form-group col-md-3">
                            ...
                            @foreach($extremidades as $key => $value)
                                <li class="list-group-item">
                                    <span class="badge">{{ $value }}</span> {{ in_array($key, array_keys(Certificate::$extremidades)) ? Certificate::$extremidades[$key] : $key }}
                                </li>
                            @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <span class="badge">{{ $certificate->n15 }}</span>
                        </div>
                        <div class="form-group col-md-2">
                            <span class="badge">{{ $certificate->a15 }}</span>
                        </div>
                    </div>
                    ...
                    <div class="row"> 
                        <div class="form-group col-md-3">
                            ...
                            @foreach($varices as $key => $value)
                                <li class="list-group-item">
                                    <span class="badge">{{ $value }}</span> {{ in_array($key, array_keys(Certificate::$varices)) ? Certificate::$varices[$key] : $key }}
                                </li>
                            @endforeach
                            </ul>
                        </div>
