            ...
            <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-1">
                            {{ Form::checkbox('si1', 'check', $certificate->si1, ['id' => 'si1', 'disabled' => 'disabled']) }}
                        </div>
                        <div class="form-group col-md-1">
                            {{ Form::checkbox('no1', 'check', $certificate->no1, ['id' => 'no1', 'disabled' => 'disabled']) }}
                        </div>
                        <div class="form-group col-md-8">
                            {{{ $certificate->observacion1 }}}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-1">
                            {{ Form::checkbox('si2', 'check', $certificate->si2, ['id' => 'si2', 'disabled' => 'disabled']) }}
                        </div>
                        <div class="form-group col-md-1">
                            {{ Form::checkbox('no2', 'check', $certificate->no2, ['id' => 'no2', 'disabled' => 'disabled']) }}
                        </div>
                        <div class="form-group col-md-8">
                            {{{ $certificate->observacion2 }}}
                        </div>
                    </div>
