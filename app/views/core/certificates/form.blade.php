            ...
            <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            {{ Form::text('hallazgo9', null, array('class' => 'form-control', 'maxlength' => 200)) }}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            {{ Form::text('hallazgo11', null, array('class' => 'form-control', 'maxlength' => 200)) }}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            {{ Form::text('hallazgo12', null, array('class' => 'form-control', 'maxlength' => 200)) }}
                        </div>
                    </div>
            ...
            <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-1">
                            {{ Form::checkbox('si1', 'check', $certificate->exists ? null : true, ['id' => 'si1']) }}
                        </div>
                        <div class="form-group col-md-1">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-1">
                            {{ Form::checkbox('si2', 'check', $certificate->exists ? null : true, ['id' => 'si2']) }}
                        </div>
                        <div class="form-group col-md-1">
