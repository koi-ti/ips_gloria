...
class Report {
	...
	public static function getAcumulados() 
	{
        ...
        $query->select(
            ...
            DB::raw('sum(CASE WHEN n15 THEN 1 ELSE 0 END) as n15'),
            ...
            DB::raw('sum(CASE WHEN a15 THEN 1 ELSE 0 END) as a15'),
    ...
    public static function getAcumuladosAbdomen() 
    {
        $query = Certificate::query();  
        $query->select('hallazgo9', DB::raw('COUNT(hallazgo9) as cantidad'));

        $query->whereNotNull('certificado.hallazgo9');
        $query->whereRaw("certificado.hallazgo9 != ''");
        ...
        $query->groupBy('certificado.hallazgo9');
        return $query->lists('cantidad', 'hallazgo9');   
    }

    public static function getAcumuladosColumna() 
    {
        $query = Certificate::query();  
        $query->select('hallazgo11', DB::raw('COUNT(hallazgo11) as cantidad'));

        $query->whereNotNull('certificado.hallazgo11');
        $query->whereRaw("certificado.hallazgo11 != ''");
        ...
        $query->groupBy('certificado.hallazgo11');
        return $query->lists('cantidad', 'hallazgo11');   
    }

    public static function getAcumuladosExtremidades() 
    {
        $query = Certificate::query();  
        $query->select('hallazgo12', DB::raw('COUNT(hallazgo12) as cantidad'));

        $query->whereNotNull('certificado.hallazgo12');
        $query->whereRaw("certificado.hallazgo12 != ''");
        ...
        $query->groupBy('certificado.hallazgo12');
        return $query->lists('cantidad', 'hallazgo12');   
    }

    public static function getAcumuladosVarices() 
    {
        $query = Certificate::query();  
        $query->select('hallazgo16', DB::raw('COUNT(hallazgo16) as cantidad'));

        $query->whereNotNull('certificado.hallazgo16');
        $query->whereRaw("certificado.hallazgo16 != ''");
        ...
        $query->groupBy('certificado.hallazgo16');
        return $query->lists('cantidad', 'hallazgo16');   
    }
}